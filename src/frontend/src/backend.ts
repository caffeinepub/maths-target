...
import type { Board as _Board, Registration as _Registration } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async register(arg0: Registration): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.register(to_candid_Registration_n7(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        board: from_candid_Board_n5(_uploadFile, _downloadFile, value.board),
        phone: value.phone,
...
function from_candid_variant_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "CBSE" in value ? Board.CBSE : "ICSE" in value ? Board.ICSE : value;
}
function from_candid_vec_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Registration>): Array<Registration> {
    return value.map((x)=>from_candid_Registration_n2(_uploadFile, _downloadFile, x));
}
function to_candid_Board_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Board): _Board {
    return to_candid_variant_n10(_uploadFile, _downloadFile, value);
}
function to_candid_Registration_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Registration): _Registration {
...
function to_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        board: to_candid_Board_n9(_uploadFile, _downloadFile, value.board),
        phone: value.phone,
        className: value.className,
        parentName: value.parentName
    };
}
function to_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Board): {
    CBSE: null;
} | {
    ICSE: null;
} {
